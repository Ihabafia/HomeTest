...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add a purchase') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('purchase.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="share_instrument_name" type="text" class="form-control{{ $errors->has('share_instrument_name') ? ' is-invalid' : '' }}" name="share_instrument_name" value="{{ old('share_instrument_name') }}" required autofocus>
